...
5. При кризисе суицидального характера — сразу даёт номер 8 (800) 100-49-94
...
| Встреча с психологом | Через партнёрскую платформу | Поддержка |
...
| Разговор с женщиной, пережившей схожий опыт | Живой человек с похожим опытом | Поддержка |
| Специалист по зависимости | Онлайн-консультация | Зависимость |

### Логика подбора 3-4 вариантов
```
ЕСЛИ потребность = жильё/некуда идти:
  → хостел + юрист + разговор с женщиной, пережившей схожий опыт

ЕСЛИ потребность = еда/деньги:
  → карточка продукты + карточка дети (если есть) + оплата проезда

ЕСЛИ потребность = документы:
  → юрист + разговор с женщиной, пережившей схожий опыт + психолог

ЕСЛИ потребность = поддержка/поговорить:
  → разговор с женщиной, пережившей схожий опыт + психолог + специалист по зависимости

ЕСЛИ потребность = дети:
  → карточка дети + юрист + разговор с женщиной, пережившей схожий опыт
...
— Разговор с женщиной, пережившей схожий опыт — она понимает изнутри
— Встреча с психологом
— Специалист по работе с зависимостью

Что ближе?
[Поговорить с женщиной, пережившей схожий опыт] [Психолог] [Специалист по зависимости] [Что-то другое]
```
...
flowchart TD
    ...
    CRISIS[/"Телефон доверия: 8 (800) 100-49-94, бесплатно, круглосуточно. Я здесь параллельно — напишите что происходит."/]
